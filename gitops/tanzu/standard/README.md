# Gitops module for Tanzu Standard repository

Are you bought-in to managing and auditing updates to Kubernetes resources via Git commits and merge requests?
Would you like to be able to install the Tanzu Standard repository without the `tanzu` CLI and necessary plugins?
...
Convert the `.tpl` files embedded in the directories underneath `standard`.
